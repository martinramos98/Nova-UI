export default function cardLayoutsCases() {
	return `<script>
import {Button, Card, Title, Image} from '@nv-org/components'
</script>
<div class="flex flex-row flex-wrap gap-4 place-content-center">
	...
	<div class="example-card-box">
		<Title level={3} class="text-lg">Custom Grid Template Area</Tit
		<Card
			color="container"
			variant="solid"
