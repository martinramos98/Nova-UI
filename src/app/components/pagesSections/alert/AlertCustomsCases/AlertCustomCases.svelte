...
<script>
	let openCase1 = $state(false);
	let openCase2 = $state(false);
	...
	import { alertCase1TextCode, alertCase2TextCode } from './textCode.js';
</script>

<section class="w-full">
	<div class="w-full">
		<ComponentCodeTabs code={alertCase1TextCode()}>
			{#snippet component()}
				<Button
					onClick={() => {
						openCase1 = true;
				...
				>
				<Alert class="relative bg-slate-800 text-white" onClose={() => {}} bind:open={openCase1}>
					<div class="mt-1">
...
<section>
	<div class="w-full">
		<ComponentCodeTabs code={alertCase2TextCode()}>
			{#snippet component()}
				<Button
					onClick={() => {
						openCase2 = true;
