...
<svelte:head>
	<title>Nova UI - Button</title>
	<meta
		name="description"
		content="Nova UI provides fully accesible and customizable buttons components. Buttons components are an interactives elements in user interfaces, designed to execute
